...
maintainer='Orkun Ergün' # rokusenpai
devicename='Redmi 9/Poco M2' # Redmi Note 7 Pro
oem='Xiaomi' # Xiaomi
zip='$(ls /tmp/rom/out/target/product/lancelot/*zip)' # ProtonPlus-13.0-Stable-violet-OFFICIAL-20220930-155814.zip
